...
/**
 * @brief Broyden-Fletcher-Goldfarb-Shanno method object
 *
 * @tparam fp_type fp+type is a floating-point template parameter
 */
...
public:
  /**
   * @brief Construct a new broyden fletcher goldfarb shanno method object
   *
