...
BOOST_AUTO_TEST_CASE(polak_ribiere_with_gs_default) {
...
#define _DEBUG_
  ...
  auto multi_dim_method = polak_ribiere_method<double>{
...
BOOST_AUTO_TEST_CASE(polak_ribiere_with_f_default) {
...
BOOST_AUTO_TEST_CASE(polak_ribiere_with_b_default) {
...
#define _DEBUG_
  ...
  std::size_t multi_max_iters = 10000;
  auto multi_dim_method = polak_ribiere_method<double>{brent, multi_max_iters,
