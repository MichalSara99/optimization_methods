...
BOOST_AUTO_TEST_CASE(davidon_fletcher_powell_with_gs_default) {
...
#define _DEBUG_
  ...
  auto multi_dim_method = davidon_fletcher_powell_method<double>{
...
BOOST_AUTO_TEST_CASE(davidon_fletcher_powell_with_f_default) {
...
BOOST_AUTO_TEST_CASE(davidon_fletcher_powell_with_b_default) {
