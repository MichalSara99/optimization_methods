...
BOOST_AUTO_TEST_CASE(hestenes_stiefel_with_gs_default) {
...
#define _DEBUG_
  ...
  auto multi_dim_method = hestenes_stiefel_method<double>{
...
BOOST_AUTO_TEST_CASE(hestenes_stiefel_with_f_default) {
...
BOOST_AUTO_TEST_CASE(hestenes_stiefel_with_b_default) {
